...
Pop is available on [Swift Package Manager](https://swift.org/package-manager/). Go to your project's 'Swift Packages' section, and enter package repository URL **https://github.com/woxtu/pop.git**, and specify branch **spm**.
